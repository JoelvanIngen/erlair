...
str showExprNoParens(fun(_, clauses)) = "fun <j("; ", [showClause("", c, true) | c <- clauses])> end";
str showExprNoParens(namedFun(_, name, clauses)) = "fun <j("; ", [showClause(name, c, true) | c <- clauses])> end";
